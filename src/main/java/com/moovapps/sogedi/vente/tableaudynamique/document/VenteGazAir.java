...
public class VenteGazAir extends BaseDocumentExtension {
		...
		try
		{
			...
			if(storageResources != null && !storageResources.isEmpty())
			{
				...
				{ 
					...
					{
						getResourceController().inform("Numero", "Aucune bouteille n'est prête pour une vente.");
					}
				}
			}
		}
	...
	public void onPropertyChanged(IProperty property) 
	{
		try 
		{
			...
			log.error("Erreur dans la classe VenteGazAir méthode onPropertyChanged: "+e.getClass()+" - "+e.getMessage());
		}
